...
namespace HtmlRendererCore.Core.Entities
{
    ...
    public sealed class HtmlImageLoadEventArgs : EventArgs
    {
        ...
        {
            this._handled = true;
            this._callback(null, null, new RRect());
        }
        ...
        public void Callback(string path)
        {
            ...
            this._handled = true;
            this._callback(path, null, RRect.Empty);
        }
        ...
        public void Callback(string path, double x, double y, double width, double height)
        {
            ...
            this._handled = true;
            this._callback(path, null, new RRect(x, y, width, height));
        }
        ...
        public void Callback(Object image)
        {
            ...
            this._handled = true;
            this._callback(null, image, RRect.Empty);
        }
        ...
        public void Callback(Object image, double x, double y, double width, double height)
        {
            ...
            this._handled = true;
            this._callback(null, image, new RRect(x, y, width, height));
        }
    }
}