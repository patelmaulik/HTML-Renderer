...
namespace HtmlRendererCore.Adapters
{
    ...
    public abstract class RAdapter
    {
        ...
        protected RAdapter()
        {
            this._fontsHandler = new FontsHandler(this);
        }
        ...
        {
            return this._fontsHandler.IsFontExists(font);
        }
        ...
        {
            this._fontsHandler.AddFontFamily(fontFamily);
        }
        ...
        {
            this._fontsHandler.AddFontFamilyMapping(fromFamily, toFamily);
        }
        ...
        {
            return this._fontsHandler.GetCachedFont(family, size, style);
        }
        ...
        public RImage GetLoadingFailedImage()
        {
            if (this._errorImage == null)
            {
                ...
                if (stream != null)
                    this._errorImage = this.ImageFromStream(stream);
            }
