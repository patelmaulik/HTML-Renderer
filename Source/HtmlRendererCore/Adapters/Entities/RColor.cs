...
namespace HtmlRendererCore.Adapters.Entities
{
    ...
    public struct RColor
    {
        ...
        public byte R
        {
            get { return (byte)((ulong)(this._value >> 16) & byte.MaxValue); }
        }
        ...
        public byte G
        {
            get { return (byte)((ulong)(this._value >> 8) & byte.MaxValue); }
        }
        ...
        public byte B
        {
            get { return (byte)((ulong)this._value & byte.MaxValue); }
        }
        ...
        public byte A
        {
            get { return (byte)((ulong)(this._value >> 24) & byte.MaxValue); }
        }
        ...
        public override bool Equals(object obj)
        {
            if (obj is RColor)
            {
                ...
                return this._value == color._value;
            }
            return false;
        }
